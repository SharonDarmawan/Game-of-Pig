...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def high(score0, score1):
        ...
        if gain != running_high and gain > running_high:
            print(gain, "point(s)! The most yet for Player", who)
            biggest_gain = gain
            return announce_highest(who, new_score, biggest_gain)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score + free_bacon(opponent_score), opponent_score):
        return 0
    elif bacon_strategy(score, opponent_score, cutoff, num_rolls)==False:
        return 0
    else:
        return num_rolls
